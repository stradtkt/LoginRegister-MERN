    ...
    return (
        <section>
            <div id="index-banner" className="parallax-container">
                ...
                <div className="parallax"><img src={back1} alt="Unsplashed background img 1"/></div>
            </div>
        <div className="container">
        ...
        <div className="parallax-container valign-wrapper">
            ...
            <div className="parallax"><img src={back2} alt="Unsplashed background img 2"/></div>
        </div>
        <div className="container">
            <div className="section">
            <div className="row">
        ...
        <div className="parallax-container valign-wrapper">
            ...
            <div className="parallax"><img src={back3} alt="Unsplashed background img 3"/></div>
        </div>
